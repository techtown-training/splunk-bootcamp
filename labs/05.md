...
- Let's edit the collectd configuration file located at `/etc/collectd/collectd.conf`. You can use VIM as sudo like this `sudo vim /etc/collectd/collectd.conf` and then edit the file.
